    ...
    return (
        <div className='islandContainer w-full h-screen '>
            ...
            <div className='relative w-full h-full flex xl:flex-row  justify-evenly items-center gap-4 px-5'>
                    <div className='thirdOne absolute xl:h-120 xl:w-120 m:w-64 m:h-64 xm:w-72 xm:h-72 sm:w-82 sm:h-82 md:w-96 md:h-96  lg:w-120 lg:h-100   z-20 bottom-20 shadow-xl/40 rounded-t-2xl overflow-hidden'>
